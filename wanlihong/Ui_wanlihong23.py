...
# Form implementation generated from reading ui file 'D:\WinProjects\pyqt_demo\wanlihong23.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.slider_stitch_position = QtWidgets.QSlider(self.centralwidget)
        self.slider_stitch_position.setGeometry(QtCore.QRect(50, 640, 850, 30))
        self.slider_stitch_position.setOrientation(QtCore.Qt.Horizontal)
        self.slider_stitch_position.setMinimum(0)
        self.slider_stitch_position.setMaximum(100)
        self.slider_stitch_position.setProperty("value", 50)
        self.slider_stitch_position.setObjectName("slider_stitch_position")
        self.textedit_inspection_notes = QtWidgets.QTextEdit(self.centralwidget)
        self.textedit_inspection_notes.setGeometry(QtCore.QRect(50, 690, 850, 80))
        self.textedit_inspection_notes.setObjectName("textedit_inspection_notes")
        self.button_save_inspection = QtWidgets.QPushButton(self.centralwidget)
        self.button_save_inspection.setGeometry(QtCore.QRect(920, 690, 60, 30))
        self.button_save_inspection.setObjectName("button_save_inspection")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textedit_inspection_notes.setPlaceholderText(_translate("MainWindow", "Add your inspection notes here..."))
        self.button_save_inspection.setText(_translate("MainWindow", "Save"))
