...
# Form implementation generated from reading ui file 'D:\WinProjects\pyqt_demo\wanlihong25.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_calculate_likelihood = QtWidgets.QPushButton(self.centralwidget)
        self.button_calculate_likelihood.setGeometry(QtCore.QRect(250, 470, 300, 30))
        self.button_calculate_likelihood.setObjectName("button_calculate_likelihood")
        self.label_likelihood_result = QtWidgets.QLabel(self.centralwidget)
        self.label_likelihood_result.setGeometry(QtCore.QRect(250, 520, 300, 30))
        self.label_likelihood_result.setAlignment(QtCore.Qt.AlignCenter)
        self.label_likelihood_result.setFrameShape(QtWidgets.QFrame.Panel)
        self.label_likelihood_result.setObjectName("label_likelihood_result")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Face Likelihood Tool"))
        ...
        self.button_calculate_likelihood.setText(_translate("MainWindow", "Calculate Likelihood"))
        self.label_likelihood_result.setText(_translate("MainWindow", "Likelihood: N/A"))
